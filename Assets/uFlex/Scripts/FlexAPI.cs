...
namespace uFlex
{
    ...
    public class Flex
    {
        ...
        #endif
        public static extern void UpdateTriangleMesh(IntPtr mesh, Vector3[] vertices, int[] indices, int numVertices, int numTriangles, ref Vector3 lower, ref Vector3 upper, Memory source);
       ...
       int[] shapeOffsets, Vector4[] shapePositions, Quaternion[] shapeRotations, Vector4[] shapePrevPositions, Quaternion[] shapePrevRotations, int[] shapeFlags, int numShapes, Memory source);
        ...
        #if (UNITY_32 || UNITY_EDITOR_32)
                [DllImportAttribute("flexRelease_x86", EntryPoint = "flexGetDensities")]
        #else
        ...
        #if (UNITY_32 || UNITY_EDITOR_32)
            [DllImportAttribute("flexRelease_x86", EntryPoint = "flexGetDiffuseParticles")]
        #else
            [DllImportAttribute("flexRelease_x64", EntryPoint = "flexGetDiffuseParticles")]
        #endif
        public static extern int GetDiffuseParticles(IntPtr solverPtr, IntPtr pos, IntPtr vel, IntPtr indices, Memory target);
        ...
        #if (UNITY_32 || UNITY_EDITOR_32)
            [DllImportAttribute("flexRelease_x86", EntryPoint = "flexSetDiffuseParticles")]
        #else
            [DllImportAttribute("flexRelease_x64", EntryPoint = "flexSetDiffuseParticles")]
        #endif
        public static extern void SetDiffuseParticles(IntPtr solverPtr, IntPtr pos, IntPtr vel, int n, Memory source);
